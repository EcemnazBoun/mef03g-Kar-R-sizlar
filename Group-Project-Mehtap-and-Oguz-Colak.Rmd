---
title: "Group Project | Mehtap & Oguz Colak"
...
PlanProdSources$Barajlı <- (Production_Monthly_Trp$barajli - Planning_Monthly_Trp$barajli)
...
* The amount of energy produced in 4 years was calculated.
...
* Energy amounts calculated according to sources were converted into data frames.
...
* In the last 4 years, the most production was obtained from natural gas (dogal_gaz), imported coal (ithal_komur) and dammed hydro (barajli). Only the negative value (about -1.6 million mwh) was obtained from the importExport (uluslararasi) source.
...
ggplot(production_mwh2, aes(x=kaynaklar, y=production_mwh)) + 
  ...
  labs(title="Total Production Amount by Years (mwh)", 
       ...
       y = "Total Sources mwh",
       x = "Sources",
       caption="source: epiaş") + 
  theme(axis.text.x = element_text(angle=65, vjust=0.6))

```

* The percentage of production of energy sources was calculated.
...
* Distribution of the percentage of production of energy sources is shown on the pie chart.
...
* The production amount of wind and solar energy as a renewable energy source is shown in a separate table.
...
* The percentage of wind and solar energy in the total amount of energy is shown on a separate pie chart.
...
* The amount of production of natural gas and fossil fuels is shown in a separate table.
...
* The percentage of natural gas and fossil fuels in the total energy amount is shown in a separate pie chart.
