---
title: "Kar-R-sızlar Final Project: Summary of The Data and Explanation"
...
# Proper Data Format
consumption_raw_data[,3]  <- as.data.frame(lapply(consumption_raw_data[,3], function(x) as.numeric(gsub(",", ".", gsub("\\.", "", x)))))
